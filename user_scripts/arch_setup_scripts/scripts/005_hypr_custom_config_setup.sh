...
# This file can also be edited with dawn monitor from the rofi menu or from dawn control center
# ==============================================================================
...
# This file can also be edited with dawn keybinds manager from the rofi menu or from dawn control center
# ==============================================================================
...
bindd = $mainMod, W, Launch Browser, exec, $browser

# Auto-generated by Text Editor Switcher
bindd = $mainMod, R, Open Text Editor, exec, $terminal --class nvim -e $textEditor

# Auto-generated by Terminal Switcher
bindd = $mainMod, Q, Launch Terminal, exec, $terminal
EOF
		;;
	"appearance.conf")
		cat <<'EOF'
...
# This file can also be edited with dawn appearance from the rofi menu or from dawn control center
# ==============================================================================
...
#
# This file can also be edited with dawn workspace manager tui,
# which can be found in dawn control center
# ==============================================================================
# USER CONFIGURATION: workspace_rules.conf
...
# ==============================================================================
# Add your custom settings for environment_variables.conf
...
# This file can also be edited with dawn input from the rofi menu or from dawn control center
# ==============================================================================
# -------------------------------------------------------------------------------------------------
# 1. KEYBOARD & LANGUAGE
# -------------------------------------------------------------------------------------------------
