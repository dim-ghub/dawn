...
readonly TARGET_FILES=(
	...
	"cache_purge.desktop"
	"clipboard_persistence.desktop"
	"dawn_appearances.desktop"
	"dawn_battery_notify.desktop"
	"dawn_control_center.desktop"
	"dawn_hyprlock_switcher.desktop"
	"dawn_hypridle_timeout.desktop"
	"dawn_hypridle_toggle.desktop"
	"dawn_input.desktop"
	"dawn_gsettings.desktop"
	"dawn_keybinds.desktop"
	"dawn_monitor.desktop"
	"dawn_matugen_presets.desktop"
	"dawn_network.desktop"
	"dawn_power.desktop"
	"dawn_waybars.desktop"
	"dawn_window_rules.desktop"
	"dawn_workspace_manager.desktop"
	"dawn_site_blocker.desktop"
	"dawn_sliders.desktop"
	"dawn_swaync_side.desktop"
	"dawn_service_toggle.desktop"
