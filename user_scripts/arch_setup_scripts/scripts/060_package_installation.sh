...
declare -ar pkgs_hyprland=(
	"hyprland" "xorg-xwayland" "xdg-desktop-portal-hyprland" "xdg-desktop-portal-gtk" "xorg-xhost" "polkit" "hyprpolkitagent" "xdg-utils" "socat" "inotify-tools" "libnotify" "file"
)
...
declare -ar pkgs_audio=(
	"pipewire" "wireplumber" "pipewire-pulse" "playerctl" "bluez" "bluez-utils" "blueman" "bluetui" "pavucontrol" "gst-plugin-pipewire" "libcanberra" "songrec" "sox" "pipewire-openrc" "wireplumber-openrc" "pipewire-pulse-openrc" "bluez-openrc"
)

# Group 6: Filesystem & Archives
declare -ar pkgs_filesystem=(
	"btrfs-progs" "compsize" "zram-generator" "zram-generator-openrc" "udisks2" "udiskie" "dosfstools" "ntfs-3g" "xdg-user-dirs" "usbutils" "gnome-disk-utility" "unzip" "zip" "unrar" "7zip" "cpio" "file-roller" "rsync"
...
# Group 9: Development
declare -ar pkgs_dev=(
	"neovim" "git" "git-delta" "lazygit" "meson" "cmake" "clang" "uv" "rq" "jq" "bc" "viu" "chafa" "ueberzugpp" "ccache" "mold" "shellcheck" "fd" "ripgrep" "fzf" "shfmt" "stylua" "prettier" "tree-sitter-cli" "nano"
)
