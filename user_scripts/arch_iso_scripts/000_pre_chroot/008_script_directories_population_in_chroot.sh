...
# We ensure the script is run from the location containing 'dawn' to satisfy relative paths.
...
# TASK 2: Copy the 'dawn' Environment
# This creates /mnt/dawn
