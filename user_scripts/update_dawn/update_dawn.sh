...
declare -A CUSTOM_SCRIPT_PATHS=(
	...
	["rofi_wallpaper_selector.sh"]="user_scripts/rofi/rofi_wallpaper_selector.sh"
	...
	["dawn_zen_tui.sh"]="user_scripts/theme_matugen/dawn_zen_tui.sh"
...
declare -ra UPDATE_SEQUENCE=(
	...
	"U | 237_text_editor_switcher.sh --apply-state"
	...
	#    "U | 390_clipboard_persistence.sh"
	...
	#    "U | 450_generate_colorfiles_for_current_wallpaper.sh"
	...
	#    "U | ignore-fail | dawn_zen_tui.sh --sync --all"
