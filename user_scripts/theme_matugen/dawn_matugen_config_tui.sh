...
register_items() {
	...
	register_template 1 "Dusky Control" "dawn_control_center" "true" ""
	register_template 1 "Dusky Sliders" "dawn_sliders" "true" ""
	...
	register_template 3 "Equibop" "equibop" "false" "equibop"
	...
	register_template 3 "Zen Web Matugen" "zen_websites" "false" ""
